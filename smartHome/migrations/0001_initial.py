# Generated by Django 3.2.4 on 2021-09-07 22:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('HM', 'Home Automation'), ('HA', 'Home Appliances'), ('HEM', 'Home Energy Management'), ('HSS', 'Home Security and Safety'), ('HF', 'Health and Fitness')], max_length=3)),
                ('product_image', models.ImageField(upload_to='products')),
                ('rating', models.FloatField(max_length=10, validators=[django.core.validators.MaxValueValidator(10)])),
            ],
        ),
        migrations.CreateModel(
            name='OrderPlaced',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='smartHome.customer')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='smartHome.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
